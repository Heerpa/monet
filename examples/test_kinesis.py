...
if __name__ == '__main__':
    ...
    record = EquipmentRecord(manufacturer='Thorlabs', model='KDC101', serial='27257033', connection=ConnectionRecord(backend=Backend.MSL, address='SDK::Thorlabs.MotionControl.KCube.DCServo.dll'))

...
def update_mm_acquisition_comment(laser, measured, unit, att_pos=None,
                                  laser_pwr=None):
    ...
    Returns:
        None on success or if pycromanager is not installed;
        an error string if the update failed.
    """
    import re
    ...
    try:
        ...
        new_settings = curr_settings.copy_builder().comment(
            new_comment).build()
